            ...
            <form class="form-inline" role="form">
                <div class="row" style="margin-bottom: 8px;">
                    <div class="form-group col-sm-6">
                        <label class="col-sm-4 control-label" for="exampleInputEmail2">登录名</label>
                        <input type="text" class="col-sm-8 form-control" id="loginName"
                               placeholder="搜索登录名">
                    </div>
                    <div class="form-group col-sm-6">
                        <label class="col-sm-4 control-label" for="exampleInputPassword2">昵称</label>
                        <input type="text" class="col-sm-8 form-control" id="displayName"
                               placeholder="搜索昵称">
                    </div>
                </div>
                <div class="row" style="margin-bottom: 8px;">
