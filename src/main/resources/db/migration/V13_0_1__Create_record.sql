...
CREATE TABLE `t_plan_summary` (
  ...
  `type` tinyint(4) DEFAULT NULL COMMENT '类型0,工作计划，1工作总结',
...
INSERT INTO `topie_campus`.`sys_function` (`id`, `parent_id`, `function_name`, `display`, `display_type`, `icon`, `action`, `function_desc`, `insert_time`, `update_time`) VALUES ('36', '0', '学生记录', '1', '2', '', '/api/front/teacherRecord/recordList', '0', '2016-11-03 22:34:19', '2016-11-03 22:34:50');

INSERT INTO `topie_campus`.`sys_role_function` (`function_id`, `role_id`) VALUES ('36', '4');
