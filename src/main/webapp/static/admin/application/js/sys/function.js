...
(function ($, window, document, undefined) {
    ...
    App.sysFunction.initEvents = function () {
        var grid;
        var options = {
            url: App.href + "/api/sys/function/pageList",
            ...
            actionColumns: [{
                ...
                handle: function (index, data) {
                    ...
                    var formOpts = {
                        ...
                        action: App.href + "/api/sys/function/update",//表单action
            ...
            tools: [
                {
                    ...
                    handle: function (grid) {
                        ...
                        var formOpts = {
                            ...
                            method: "POST",
                            action: App.href + "/api/sys/function/insert",//表单action
                            ajaxSubmit: true,//是否使用ajax提交表单
                            rowEleNum: 1,
                            beforeSubmit: function () {
                            },
        ...
        grid = window.App.content.find("#function_grid").topieGrid(options);
    }
