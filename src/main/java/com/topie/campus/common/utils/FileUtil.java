...
public class FileUtil {
    ...
    public static String saveFileFromMultipartFile(MultipartFile file, String path)
            throws IOException {
    ...
    public static String saveFileFromMultipartFileCreateNewName(MultipartFile file, String path)
            throws IOException {
        String fileName = String.valueOf(System.currentTimeMillis()) + file.getOriginalFilename()
                .substring(file.getOriginalFilename().lastIndexOf("."));
        File targetFile = new File(path);
