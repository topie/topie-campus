...
public class DateUtil {
    ...
    public static String IntToDateString(Integer seconds, DateStyle dateStyle) {
        return IntToDateString(Long.valueOf(seconds * 1000L), DateStyle.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String IntToDateString(Long millionSeconds, DateStyle dateStyle) {
        return DateToString(new Date(millionSeconds), DateStyle.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String StringToString(String date, DateStyle dateStyle) {
        return StringToString(date, dateStyle, dateStyle);
    }
    ...
    public static Date getMonthFirstDay(String date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(StringToDate(date, DateStyle.YYYY_MM_DD));
        cal.set(Calendar.DAY_OF_MONTH, 1);
        return cal.getTime();
    }

    public static Date getLastMonthFirstDay(String date) {
        Date lastMonth = addMonth(StringToDate(date, DateStyle.YYYY_MM_DD), -1);
        Calendar cal = Calendar.getInstance();
